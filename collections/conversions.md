...
Map<int, int> numbersMap = Map.fromIterable(numbers, key: (number) => number, value: (number) => number * 10);
...
Map<int, int> numbersMap2 = Map.fromIterable(numbers2, key: (number) => number, value: (number) => number * 10);
